...
:th-version: v2.14-beta2+fall2025
...
| Matter 1.5     | v2.14-beta1.1+winter2025   | N/A                                                                                         | TBD | 7c9b126      | To install, use the tag "v2.14-beta2+fall2025" in the instructions of <<fresh_install>>
|===
